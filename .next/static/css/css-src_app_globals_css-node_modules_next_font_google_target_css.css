...
::backdrop {
  ...
  .bg-\[\#0F3D8C\] {
  --tw-bg-opacity: 1;
  background-color: rgb(15 61 140 / var(--tw-bg-opacity));
}
  .bg-\[\#1348A5\] {
  --tw-bg-opacity: 1;
  background-color: rgb(19 72 165 / var(--tw-bg-opacity));
}
  .bg-\[\#18D2A5\] {
  --tw-bg-opacity: 1;
  background-color: rgb(24 210 165 / var(--tw-bg-opacity));
}
  .bg-\[\#F0648C\] {
  --tw-bg-opacity: 1;
  background-color: rgb(240 100 140 / var(--tw-bg-opacity));
}
  .bg-\[\#F0F4F8\] {
  --tw-bg-opacity: 1;
  ...
  .bg-\[\#DBF6EE\] {
  --tw-bg-opacity: 1;
  background-color: rgb(219 246 238 / var(--tw-bg-opacity));
}
  .bg-red-400 {
  --tw-bg-opacity: 1;
  ...
  .text-\[\#082864\] {
  --tw-text-opacity: 1;
  color: rgb(8 40 100 / var(--tw-text-opacity));
}
  .text-\[\#499D8B\] {
  --tw-text-opacity: 1;
  color: rgb(73 157 139 / var(--tw-text-opacity));
}
  .text-\[\#7886A4\] {
  --tw-text-opacity: 1;
  color: rgb(120 134 164 / var(--tw-text-opacity));
}
  .text-\[\#BAC8E5\] {
  --tw-text-opacity: 1;
  color: rgb(186 200 229 / var(--tw-text-opacity));
}
  .text-\[\#ED5585\] {
  --tw-text-opacity: 1;
  color: rgb(237 85 133 / var(--tw-text-opacity));
}
  .text-\[\#FFF\] {
  --tw-text-opacity: 1;
  ...
  .hover\:bg-\[\#2B5AAE\]:hover {
  --tw-bg-opacity: 1;
  background-color: rgb(43 90 174 / var(--tw-bg-opacity));
}
